...
y_5d.to_csv(save_path_y)

data_5d.to_csv(save_path_x)
...
train_predict.train_test_pickle(x_train,x_valid,y_train,y_valid,x_test,y_test,col_index=col_index,num_boost=10,f_horizon=5,params=params,feature_num=feature_num,model_name = 'model_5d',full_sample_data = data_5d,full_sample_y = y_5d,full_data = data_0,f_names = f_names,percentile = p)