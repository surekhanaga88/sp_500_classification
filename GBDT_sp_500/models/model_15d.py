...
y_15d = helper_funcs.create_target_series(sp_return5,percentile_list,f_horizon=15)
...
y_15d.to_csv(save_path_y)

data_15d.to_csv(save_path_x)
...
train_size,valid_size,test_size = helper_funcs.data_split_size(data_15d,0.75)


x_train,y_train,x_valid,y_valid,x_test,y_test = helper_funcs.data_split(data_15d,y_15d,train_size,valid_size,test_size)
...
train_predict.train_test_pickle(x_train,x_valid,y_train,y_valid,x_test,y_test,col_index=col_index,num_boost=10,f_horizon=15,params=params,feature_num=feature_num,model_name = 'model_15d',full_sample_data = data_15d,full_sample_y = y_15d,full_data = data_0,f_names = f_names,percentile = p)